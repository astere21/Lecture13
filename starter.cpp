...
public:
    ...
    Fraction& operator+=(const Fraction& rhs) {
        ...
        int temp_gcd = std::gcd(numerator, denominator);
        numerator = numerator / temp_gcd;
...
Fraction operator+(const Fraction& lhs, const Fraction& rhs) {
    int temp_numerator = lhs.numerator * rhs.denominator + lhs.denominator * rhs.numerator;
    int temp_denominator = lhs.denominator * rhs.denominator;
    int temp_gcd = std::gcd(temp_numerator, temp_denominator);
    temp_numerator = temp_numerator / temp_gcd;
    temp_denominator = temp_denominator / temp_gcd;
